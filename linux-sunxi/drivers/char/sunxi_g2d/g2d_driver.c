...
int g2d_blit_h(g2d_blt_h *para)
{
	...
	src->align[0] = para->src_image_h.align[0];
	src->align[1] = para->src_image_h.align[1];
	src->align[2] = para->src_image_h.align[2];
	...
	dst->align[0] = para->dst_image_h.align[0];
	dst->align[1] = para->dst_image_h.align[1];
	dst->align[2] = para->dst_image_h.align[2];
	dst->laddr[0] = para->dst_image_h.laddr[0];
	dst->laddr[1] = para->dst_image_h.laddr[1];
	dst->laddr[2] = para->dst_image_h.laddr[2];
	dst->width = para->dst_image_h.width;
