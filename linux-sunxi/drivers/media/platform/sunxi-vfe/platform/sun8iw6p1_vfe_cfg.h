...
#define VFE_CSI_REGULATOR				"vcc-csi2-18"
...
#define ISP_LINEAR_LUT_LENS_GAMMA_MEM_SIZE 0x800
...
#define MAX_ISP_STAT_BUF  5
#define MAX_SENSOR_DETECT_NUM  3
