				...
				struct combo_lane_map *map)
{
	...
	if (info->isp_wdr_mode == ISP_DOL_WDR_MODE) {
		...
		map->lvds_lane1 = LVDS_MAPPING_A_D0_TO_LANE1;
		map->lvds_lane2 = LVDS_MAPPING_A_D1_TO_LANE2;
		map->lvds_lane3 = LVDS_MAPPING_A_D3_TO_LANE3;
		map->lvds_lane4 = LVDS_MAPPING_B_D2_TO_LANE4;
		map->lvds_lane5 = LVDS_MAPPING_B_D0_TO_LANE5;
		map->lvds_lane6 = LVDS_MAPPING_B_D1_TO_LANE6;
		map->lvds_lane7 = LVDS_MAPPING_B_D3_TO_LANE7;
		map->lvds_lane8 = LVDS_MAPPING_C_D2_TO_LANE8;
		map->lvds_lane9 = LVDS_MAPPING_C_D0_TO_LANE9;
				...
				struct v4l2_mbus_config *cfg)
{
	...
	if (info->isp_wdr_mode == ISP_DOL_WDR_MODE) {
		cfg->flags = 0 | V4L2_MBUS_SUBLVDS_10_LANE | V4L2_MBUS_CSI2_CHANNEL_0 | V4L2_MBUS_CSI2_CHANNEL_1;
	} else {
