...
#define DEBUG_SAVE_ITEM_NUM   10  /*MAX num to save by debug_save_item().*/
#define DEBUG_SAVE_ITEM_DEPTH 512
typedef struct s_debug_save_items {
	u32 item_num; /*valid item num*/
	u32 wr_idx; /*next index to write*/
	u32 wr_depth;
	u32 total_cnt;
	u32 save_item[DEBUG_SAVE_ITEM_NUM][DEBUG_SAVE_ITEM_DEPTH];
} debug_save_items;
extern debug_save_items DbgSaveItems;
