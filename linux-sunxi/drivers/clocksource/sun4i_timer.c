...
static void __init sun4i_timer_init(struct device_node *node)
{
	...
	/*
	 * if we set the minimum clock ticks to TIMER_SYNC_TICKS,
	 * sun4i_clkevt_next_event has opportunities to set 0 to
	 * TIMER_INTVAL_REG, and this can not produce interrupt.
	 * So, set the minimum clock ticeks to TIMER_SYNC_TICKS + 1.
	 */
