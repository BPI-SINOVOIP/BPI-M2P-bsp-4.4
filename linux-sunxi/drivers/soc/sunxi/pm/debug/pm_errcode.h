/*
 * drivers/soc/sunxi/pm/debug/pm_errcode.h
...
#ifndef _PM_ERRCODE_H
#define _PM_ERRCODE_H
...
#define BOOT_UPGRADE_FLAG	(0x5A)
#else
/*Notice: 0x5a is occupied by boot for upgrade. */
#define BOOT_UPGRADE_FLAG	(0x5AA5A55A)
#endif
...
enum err_resume_complete_flag {
	ERR_RESUME_COMPLETE_FLAG_DONE =
		ERROR_BEGIN_OF_MODULE(MOD_RESUME_COMPLETE_FLAG),
...
enum err_suspend_processors {
	ERR_SUSPEND_PROCESSORS_DONE =
		ERROR_BEGIN_OF_MODULE(MOD_SUSPEND_PROCESSORS),
...
enum err_resume_processors {
	ERR_RESUME_PROCESSORS_DONE =
		ERROR_BEGIN_OF_MODULE(MOD_RESUME_PROCESSORS),
...
enum err_suspend_devices {
	ERR_SUSPEND_DEVICES_SUSPEND_DEVICES_DONE =
		ERROR_BEGIN_OF_MODULE(MOD_SUSPEND_DEVICES),
...
enum err_resume_devices {
	ERR_RESUME_DEVICES_EARLY_RESUME_DEVICES_DONE =
		ERROR_BEGIN_OF_MODULE(MOD_RESUME_DEVICES),
...
enum err_resume_cpu0 {
	ERR_RESUME_CPUXSYS_CONFIG_WAKEUP_SRC_DONE =
		ERROR_BEGIN_OF_MODULE(MOD_RESUME_CPUXSYS),
...
enum err_suspend_cpu0 {
	ERR_SUSPEND_CPUXSYS_SHOW_DEVICES_STATE_DONE =
		ERROR_BEGIN_OF_MODULE(MOD_SUSPEND_CPUXSYS),
...
extern const char *pm_errstr(error_t error);
