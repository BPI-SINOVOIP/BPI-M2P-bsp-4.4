...
*				which contains some important infomations
*				such as magic, platform information and so on,
*				and MUST be allocted in the head of Resume.
*
...
const resume_file_head_t  resume_head = {
		...
		(0xEA000000 | (((sizeof(resume_file_head_t) +
			sizeof(int) - 1) / sizeof(int) - 2) & 0x00FFFFFF)),
		/* 0xe3a0f000, */
		RESUMEX_MAGIC,
		STAMP_VALUE,
		RESUMEX_ALIGN_SIZE,
