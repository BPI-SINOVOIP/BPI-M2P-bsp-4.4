...
static struct disp_drv_info *s_disp_drv;
static int s_client;
...
static int init_composer2_private(unsigned int disp,
	composer_private_t *priv, struct disp_drv_info *disp_drv)
{
	int i = 0;
...
static int composer2_start(struct disp_drv_info *p_disp_drv, int client)
{
	unsigned int disp;
...
static int composer2_stop(struct disp_drv_info *p_disp_drv)
{
...
int composer2_init(struct disp_drv_info *p_disp_drv)
{
...
int composer2_start_extern(struct disp_drv_info *p_disp_drv, int client)
{
