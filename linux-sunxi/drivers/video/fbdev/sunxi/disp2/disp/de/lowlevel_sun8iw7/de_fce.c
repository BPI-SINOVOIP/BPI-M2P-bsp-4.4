...
/*********************************************************************************************************************
* function       : de_fce_set_window(unsigned int sel, unsigned int chno, unsigned int win_enable, struct de_rect window)
...
* return         :
		success
*********************************************************************************************************************/
int de_fce_set_window(unsigned int sel, unsigned int chno, unsigned int win_enable, struct de_rect window)
{
...
/*********************************************************************************************************************
* function       : de_fce_set_para(unsigned int sel, unsigned int chno, unsigned int lce_en, unsigned int ftc_en, unsigned int ce_en, unsigned int hist_en)
...
/*********************************************************************************************************************
* function       : de_fce_get_hist(unsigned int sel, unsigned int chno, unsigned int hist[256], unsigned int *sum)
...
/*********************************************************************************************************************
* function       : de_fce_info2para(unsigned int sharp, unsigned int auto_contrast, unsigned int auto_color, struct de_rect window, __fce_config_data *para)
...
*                success
*********************************************************************************************************************/
int de_fce_info2para(unsigned int sharp, unsigned int auto_contrast, unsigned int auto_color, struct de_rect window, __fce_config_data *para)
{
...
*     2.kick out the lowest black and the highest white in hist and sum*/
	...
	if (validcnt != 0) {
	    ...
	    if (pd_s3 == 256)
		pd_s2 = 256;
		} else {	/*no enough pixel for autos*/
		pd_ymin_fix = 16;
		pd_black = 32;
		pd_white = 224;
		pd_ymax_fix = 240;
