...
struct disp_video_timings video_timing[] =
{
	...
	{HDMI1280_800,       0, 67500000/*69300000*/, 0,   1280,  800,  1353,   9,   16,   48,   854,  50,  1,   3, 0,   0,   0,    0,  0},
	{HDMI400_1280,       0, 43000000, 0,   400,  1280,   540,   30,  100,  10,  1322,  12, 20, 10,  1,   1,   0,    0,  0},
};
...
static s32 video_config(u32 vic)
{
	...
	__inf("video_config, "
	      "vic:%d,cts_enable:%d,isHDMI:%d,YCbCr444_Support:%d,hdcp_enable:%"
	      "d\n",
	      vic, cts_enable, isHDMI, hdmi_edid_is_yuv(), hdcp_enable);
