...
#endif
	if(SZ_16K == NF_BLOCK_SIZE)
	{
		NF_BLK_SZ_WIDTH = 14;
		blk_for_boot1   = BLKS_FOR_BOOT1_IN_16K_BLK_NF;
	}
	else if(SZ_32K == NF_BLOCK_SIZE)
	{
		NF_BLK_SZ_WIDTH = 15;
		blk_for_boot1   =  BLKS_FOR_BOOT1_IN_32K_BLK_NF;
	}
	else if(SZ_128K == NF_BLOCK_SIZE)
	{
		NF_BLK_SZ_WIDTH = 17;
		blk_for_boot1   =  BLKS_FOR_BOOT1_IN_128K_BLK_NF;
	}
	else if(SZ_256K == NF_BLOCK_SIZE)
	{
		NF_BLK_SZ_WIDTH = 18;
		blk_for_boot1   =  BLKS_FOR_BOOT1_IN_256K_BLK_NF;
	}
	else if(SZ_512K == NF_BLOCK_SIZE)
	{
		NF_BLK_SZ_WIDTH = 19;
		blk_for_boot1   =  BLKS_FOR_BOOT1_IN_512K_BLK_NF;
	}
	else if(SZ_1M == NF_BLOCK_SIZE)
	{
		NF_BLK_SZ_WIDTH = 20;
		blk_for_boot1   =  BLKS_FOR_BOOT1_IN_1M_BLK_NF;
	}
	else if(SZ_2M == NF_BLOCK_SIZE)
	{
		NF_BLK_SZ_WIDTH = 21;
		blk_for_boot1   =  BLKS_FOR_BOOT1_IN_2M_BLK_NF;
	}
	else if(SZ_4M == NF_BLOCK_SIZE)
	{
		NF_BLK_SZ_WIDTH = 22;
		blk_for_boot1   =  BLKS_FOR_BOOT1_IN_4M_BLK_NF;
	}
	else if(SZ_8M == NF_BLOCK_SIZE)
	{
		NF_BLK_SZ_WIDTH = 23;
		blk_for_boot1   =  BLKS_FOR_BOOT1_IN_8M_BLK_NF;
	}
	else if((NF_BLOCK_SIZE > SZ_4M)&&(NF_BLOCK_SIZE < SZ_8M))
	{
		blk_for_boot1   =  BLKS_FOR_BOOT1_IN_4M_BLK_NF;
	}
	else if(NF_BLOCK_SIZE > SZ_8M)
	{
		blk_for_boot1   =  BLKS_FOR_BOOT1_IN_4M_BLK_NF;
	}
	else
...
#endif
	if(SZ_512 == NF_PAGE_SIZE)
	{
		NF_PG_SZ_WIDTH =  9;
	}
	else if(SZ_2K == NF_PAGE_SIZE)
	{
		NF_PG_SZ_WIDTH = 11;
	}
	else if(SZ_4K == NF_PAGE_SIZE)
	{
		NF_PG_SZ_WIDTH = 12;
	}
	else if(SZ_8K == NF_PAGE_SIZE)
	{
		NF_PG_SZ_WIDTH = 13;
	}
	else if(SZ_16K == NF_PAGE_SIZE)
	{
		NF_PG_SZ_WIDTH = 14;
	}
	else if((NF_PAGE_SIZE > SZ_8K)&&(NF_PAGE_SIZE < SZ_16K))
	{

	}
	else if(NF_PAGE_SIZE > SZ_16K)
	{
