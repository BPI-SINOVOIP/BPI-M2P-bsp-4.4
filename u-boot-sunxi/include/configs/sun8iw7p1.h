...
#define CONFIG_SYS_PROMPT		"BPI-IoT# " /* "sunxi#" BPI */
...
#define SUNXI_CPUS_CODE_SIZE_ADDR                    (0x42d00000)
#define SUNXI_CPUS_CODE_BUFF_ADDR                    (0x42d00000 + 16)
#define SUNXI_SYSCONFIG_SIZE_ADDR                    (0x43300000)
#define SUNXI_SYSCONFIG_BUFF_ADDR                    (0X43300000 + 16)
...
#define CONFIG_WIDEVINE_KEY_INSTALL 1
#endif /* __CONFIG_H */
